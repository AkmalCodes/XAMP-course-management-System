...
<div id="profile-container">
    <div class="grid-container">
        ...
        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <input type="text" id="course_name" name="course_name" value="<?php echo isset($edit_data) ? $edit_data['course_name'] : ''; ?>" required><br><br>

            <label for="course_description">Course Description:</label><br>
            <textarea id="course_description" name="course_description" rows="4" cols="50" required><?php echo isset($edit_data) ? $edit_data['course_description'] : ''; ?></textarea><br><br>

            <label for="course_credit">Course Credit:</label>
            <input type="number" id="course_credit" name="course_credit" value="<?php echo isset($edit_data) ? $edit_data['course_credit'] : ''; ?>" required><br><br>

            <label for="course_length">Course Length:</label>
            <input type="text" id="course_length" name="course_length" value="<?php echo isset($edit_data) ? $edit_data['course_length'] : ''; ?>" required><br><br>

            <label for="instructor_id">Instructor ID:</label>
            <input type="text" id="instructor_id" name="instructor_id" value="<?php echo isset($edit_data) ? $edit_data['instructor_id'] : ''; ?>" required><br><br>
